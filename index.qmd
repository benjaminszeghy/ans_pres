...
- Countries operate under incompatible liability regimes, creating variance in domestic law among countries and uncertainty in compensation of nuclear damage
- Mature nuclear economies including China and South Korea are still not party to any nuclear liability conventions, and reciprocity gaps persist even among neighbors
...
- Overlaid NASA GPWv4 gridded population data to quantify the number of people living within legal coverage gaps
...
::: {.figure-caption}
Nuclear liability amounts under different liability regimes vs. actual damages from Three Mile Island (1979) and Fukushima (2011). Government is insurer of last resort in all cases.
:::
...
- Reactor locations & operational status: IAEA Power Reactor Information System (PRIS), as of end of 2024; geographical coordinates obtained via GeoHack
- Convention membership: OECD NEA and IAEA Office of Legal Affairs — countries that "ratified, acceded, accepted, or approved" the VC, PC, JP, BSC, and CSC
- Country borders & boundaries: Esri World Countries (Data and Maps)
- Population: NASA Gridded Population of the World v4 rev11 (GPWv4)
:::
...
- 80 km (50 mi) buffer radius around all reactor sites — the US NRC-recommended Ingestion Exposure Pathway Emergency Planning Zone for light water reactors
...
- Economic damages can extend well beyond the local vicinity of plants (e.g. South Korean fishing industry post-Fukushima, Italian and UK farmers post-Chernobyl)
...
<div class="finding-row"><span class="finding-stat">26 reactors</span><span class="finding-desc">currently have 80 km radii overlapping borders with no reciprocity</span></div>
...
<div class="finding-row"><span class="finding-stat">Fukushima ($200B+)</span><span class="finding-desc">dwarfed max insured amounts ($17B at best, &lt;$2B in most regimes)</span></div>
</div>
...
2. 71,000 km (56%) of global borders have no nuclear liability reciprocity; 1.9 million people live within 80 km of a reactor crossing one of those borders with no guaranteed legal avenue for compensation.
