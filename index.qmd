...
|:--|:--|:--|:--|:--|
| **Paris Convention** | 1960 | Western Europe | ~USD 21M (orig.) | Legal channeling to operator |
| **Vienna Convention** | 1963 | Eastern Europe | ~USD 5M (orig.) | Strict & exclusive operator liability |
| **Joint Protocol** | 1988 | Paris + Vienna parties | N/A (bridge) | Bridges Paris + Vienna reciprocity |
| **Brussels Supp.** | 1963 | Paris Conv. states | ~EUR 1.5B (revised) | Multi-tier supplementary fund |
| **CSC** | 1997 | Intended global | ~USD 600M+ | Supplementary fund from all parties |
| **US Price-Anderson** | 1957 | United States | ~USD 17B (total) | Two-tier: private insurance + pool |
...
::: {.slide-left}
**Convention membership, by country**

- **Solid lines** — borders with no reciprocity
- **Dashed lines** — borders with reciprocity
- **Circles** — reactor 50-mile (80 km) buffer radius
...
::: {.slide-left}
**Population exposure to non-reciprocal borders**

- **Darker blue** — higher population density
- **Circles** — reactor 50-mile (80 km) buffer
- Border lines indicate reciprocity classification
